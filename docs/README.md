...
| [`دستورالعمل تکمیلی تحویل و ارزیابی پروژه‌های نهایی (Best Practices).md`](دستورالعمل%20تکمیلی%20تحویل%20و%20ارزیابی%20پروژه‌های%20نهایی%20(Best%20Practices).md) | Course final-delivery & evaluation guidelines (PDF + Markdown) |

> Full report and presentation materials are linked in the main [README](../README.md).
